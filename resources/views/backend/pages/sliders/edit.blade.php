...
@section('admin-content')
    ...
    <div class="container-fluid">
        ...
        <div class="create-page">
            <form action="{{ route('admin.sliders.update', $slider->id) }}" method="POST" enctype="multipart/form-data" data-parsley-validate data-parsley-focus="first">
                @csrf
                @method('put')
                <div class="form-body">
                    <div class="card-body">
                        <div class="row ">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="slug" name="slug" value="{{ $slider->slug }}" placeholder="Enter short url (Keep blank to auto generate)" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control dropify" data-height="70" data-allowed-file-extensions="png jpg jpeg webp" id="image" name="image" data-default-file="{{ $slider->image != null ? asset('public/assets/images/sliders/'.$slider->image) : null }}"/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-success">
                                    ...
                                    <select class="form-control custom-select" id="is_button_enable" name="is_button_enable" required>
                                        <option value="1" {{ $slider->is_button_enable === 1 ? 'selected' : null }}>Enabled</option>
                                        <option value="0" {{ $slider->is_button_enable === 0 ? 'selected' : null }}>Disabled</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-success">
                                    ...
                                    <select class="form-control custom-select" id="is_blank_redirect" name="is_blank_redirect" required>
                                        <option value="1" {{ $slider->is_blank_redirect === 1 ? 'selected' : null }}>Yes</option>
                                        <option value="0" {{ $slider->is_blank_redirect === 0 ? 'selected' : null }}>No</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-success">
                                    ...
                                    <select class="form-control custom-select" id="is_description_enable" name="is_description_enable" required>
                                        <option value="1" {{ $slider->is_description_enable === 1 ? 'selected' : null }}>Yes</option>
                                        <option value="0" {{ $slider->is_description_enable === 0 ? 'selected' : null }}>No</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row ">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control tinymce_advance" id="short_description" name="short_description">{!! $slider->short_description !!}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group has-success">
                                    ...
                                    <select class="form-control custom-select" id="status" name="status" required>
                                        <option value="1" {{ $slider->status === 1 ? 'selected' : null }}>Active</option>
                                        <option value="0" {{ $slider->status === 0 ? 'selected' : null }}>Inactive</option>
                                    </select>
                                </div>
